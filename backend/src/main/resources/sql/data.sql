...
VALUES
  (1,'RTX 4060 Ti','MSI GeForce RTX 4060 Ti 8GB GDDR6 Ventus 3X OC',799.99,10,TRUE,'NV-RTX-4060-TI','NVIDIA','/images/4060ti.jpeg',NOW(),NOW()),
  ...
  (1,'RTX 4080','Gigabyte GeForce RTX 4080 16GB GDDR6X Aero OC',2399.99,3,TRUE,'NV-RTX-4080','NVIDIA','/images/4080.jpeg',NOW(),NOW()),
  (1,'RTX 5090','PNY GeForce RTX 5090 32GB GDDR7 Overclocked Triple Fan',4999.99,2,TRUE,'NV-RTX-5090','NVIDIA','/images/5090.jpeg',NOW(),NOW()),
  (1,'RX 9070','PowerColor Radeon RX 9070 16GB GDDR6 Red Devil OC',799.99,12,TRUE,'AMD-RX-9070','AMD','/images/9070.jpeg',NOW(),NOW()),
  ...
  (1,'RX 9070 XT','Sapphire Radeon RX 9070 XT 16GB GDDR6 Pure',699.99,10,TRUE,'AMD-RX-9070-XT','AMD','/images/9070xt.jpeg',NOW(),NOW()),
  ...
  (1,'RX 6800 XT','PowerColor Radeon RX 6800 XT 16GB GDDR6 Red Dragon',999.99,12,TRUE,'AMD-RX-6800-XT','AMD','/images/6800xt.jpeg',NOW(),NOW()),
  ...
  (2,'Ryzen 7 5800X','AMD Ryzen 7 5800X 3.8GHz',149.99,10,TRUE,'AMD-R7-5800X','AMD','/images/r75800x.jpeg',NOW(),NOW()),
  (2,'Ryzen 7 7800X3D','AMD Ryzen 7 7800X3D 4.2GHz',289.99,5,TRUE,'AMD-R7-7800X3D','AMD','/images/r77800x3d.jpeg',NOW(),NOW()),
  (2,'Ryzen 3 4100','AMD Ryzen 3 4100 3.8GHz',39.99,8,TRUE,'AMD-R3-4100','AMD','/images/r34100.jpeg',NOW(),NOW()),
  (2,'Ryzen 5 7600X','AMD Ryzen 5 7600X 4.7GHz',169.99,20,TRUE,'AMD-R5-7600X','AMD','/images/r57600x.jpeg',NOW(),NOW()),
  (2,'Ryzen 5 5600G','AMD Ryzen 5 5600G 3.9GHz',179.99,30,TRUE,'AMD-R5-5600G','AMD','/images/r55600g.jpeg',NOW(),NOW()),
  (2,'i7-14700K','Intel Core i7-14700K 2.5GHz',349.99,10,TRUE,'INTEL-I7-14700K','INTEL','/images/i714700k.jpeg',NOW(),NOW()),
  (2,'i5-14400F','Intel Core i5-14400F 1.8GHz',179.99,10,TRUE,'INTEL-I5-14400F','INTEL','/images/i514400f.jpeg',NOW(),NOW())
AS new
ON DUPLICATE KEY UPDATE
